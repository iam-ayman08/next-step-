...
from app.core.database import create_db_and_tables, SessionLocal, User, Profile, Scholarship, Project, AlumniExpertise
import json
...
if __name__ == "__main__":
    print("🚀 Initializing NextStep database with sample data...")
    init_sample_data()
